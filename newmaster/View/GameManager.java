...
/******************************************************************
* This shows the transparent rectangle when hovering over each
* column. This aspect is used to decide where you want to 
* drop your chip.
******************************************************************/
...
/******************************************************************
* Creates the background of orange/yellow on our game board, also 
* used in our menu pages.
******************************************************************/
private void createBackground() {
	Image backgroundImage = new Image("model/resources/Slider-CL01-Background-256x256.png",
			256,256,false,true);
