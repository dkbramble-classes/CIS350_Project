      ...
      for (int j = 0; j < height; j++) {
        ...
        for (int p = 1; p <= numPlayers; p++) {
          ...
          if (j < height - 3) {
            ...
            // vertical win
            if (gameGrid[i][j] == p && gameGrid[i][j + 1] == p && gameGrid[i][j + 2] == p 
                && gameGrid[i][j + 3] == p) {
              return p;
            }
          }
          ...
          if (i < width - 3) {
            // horizontal win
            if (gameGrid[i][j] == p && gameGrid[i + 1][j] == p && gameGrid[i + 2][j] == p 
                && gameGrid[i + 3][j] == p) {
              return p;
            }
          }
          ...
          if (i < width - 3 && j < height - 3) {
            ...
            // diagonal down
            if (gameGrid[i][j] == p && gameGrid[i + 1][j + 1] == p && gameGrid[i + 2][j + 2] == p
                && gameGrid[i + 3][j + 3] == p) {
              return p;
            }
          }
